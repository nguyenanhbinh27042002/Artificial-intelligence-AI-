...
class Frames:
    ...
    labelImg = 0 #Hiển thị "Phát hiện Covid " và "Không Phát hiện Covid"
    ...
    def __init__(self, mainObj, MainWin, wWidth, wHeight, function, Object, xAxis=10, yAxis=10):
        ...
        self.MainWindow.title("Covid Detection")  # Tiêu đề cửa sổ
        ...
        self.winFrame = tkinter.Frame(self.MainWindow, width=wWidth,
                                      height=wHeight)  # nằm trong cửa sổ, chiều dài, chiều rộng
...
#Cài đặt nút nhất Close
    ...
    def displayImage(self):
        ...
        self.labelImg = tkinter.Label(self.winFrame,
                                      image=self.image)  # ẢNh hiện thị trong khung winFrame và ảnh hiển thị alf ảnh sau khi xử lý
