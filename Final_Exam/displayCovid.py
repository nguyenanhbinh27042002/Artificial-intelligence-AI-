...
class DisplayVirus:
    ...
    def removeNoise(self):
        ...
        # loại bỏ nhiễu bên ngoài la phoi bi nhiem covid cần xác định(dùng Open), iterations(lặp đi lặp lại)
    ...
    def displayVirus(self):
        ...
        VirusImage = cv.cvtColor(self.Img, cv.COLOR_HSV2BGR)
        self.curImg = VirusImage